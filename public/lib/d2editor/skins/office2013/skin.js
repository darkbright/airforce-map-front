...
CKEDITOR.skin.addIcon('textLarger','./skins/office2013/textLarger.png',2,"11px");
CKEDITOR.skin.addIcon('textSmaller','./skins/office2013/textSmaller.png',1,"11px");
CKEDITOR.skin.addIcon('bgstyle','./skins/office2013/bgstyle.png');
CKEDITOR.skin.addIcon('letterspacing','./skins/office2013/letterspacing.png',2,"13px");
CKEDITOR.skin.addIcon('lineheight','./skins/office2013/lineheight.png',2,"13px");
CKEDITOR.skin.chameleon = ( function() {
	...
	templates = {
		...
		panel: new CKEDITOR.template(
            ...
            // letter spacing bg color
            '.custom_letterspacing div:hover, .custom_letterspacing div.checked [' +
                    'background-color:{menubuttonIconHover};' +
                '] ' +

            //line height bg color
            '.custom_lineheight div:hover, .custom_lineheight div.checked [' +
                    'background-color:{menubuttonIconHover};' +
                '] '
		)
	};
	...
	return function( editor, part ) {
		var uiColor = editor.uiColor,
			...
			templateStyles = {
				...
				defaultGradient: colorBrightness( uiColor, 0.5 ),//verticalGradient( colorBrightness( uiColor, 0.9 ), uiColor ),
				lightGradient: colorBrightness( uiColor, 0.5 ),//verticalGradient( colorBrightness( uiColor, 1 ), colorBrightness( uiColor, 0.7 ) ),
				mediumGradient: colorBrightness( uiColor, 0.5 ),//verticalGradient( colorBrightness( uiColor, 0.8 ), colorBrightness( uiColor, 0.5 ) ),

				// These are for specific UI elements.
				ckeButtonOn:  colorBrightness( uiColor, 0.5 ),//verticalGradient( colorBrightness( uiColor, 0.6 ), colorBrightness( uiColor, 0.7 ) ),
				...
				dialogTabSelected:  colorBrightness( uiColor, 0.5 ),//verticalGradient( '#FFFFFF', '#FFFFFF' ),
